...
function doTwerkAction() {
    var rand = require('./../../../pics/twerk-pics.json');
...
module.exports = class extends Command {
	...
	constructor(...args) {
		super(...args, {
			aliases: ['twerk', "twerking"],
			description: 'Generate Twerk gif.',
			category: 'NSFW',
			usage: ' '
		});
	}
                      ...
                      setTimeout(() => {
                        cooldown.delete(message.author.id)
                            ...
                            const dembed = new Discord.MessageEmbed()
                                ...
                                .setColor("#FFB3C4")
                                .setAuthor('🍑' + message.author.username + '🍑')
                                .setImage(doTwerkAction())
                                .setFooter('❤️TWERKU 🍑 TWERKU❤️')
